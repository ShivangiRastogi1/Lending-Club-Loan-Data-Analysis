...
This will help reduce the number of features and give the most relevant features

4.     Modeling

After applying EDA and feature engineering, build the predictive models
